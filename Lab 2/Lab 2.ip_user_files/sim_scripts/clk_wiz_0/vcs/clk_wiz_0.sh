...
#
# Generated by Vivado on Mon Oct 14 00:07:34 -0500 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Lab\\ 2.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../Lab 2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl" \
  2>&1 | tee -a vhdlan.log
